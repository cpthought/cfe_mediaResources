    ...
    <div class="page-group">
        <div class="page page-current">
          ...
          <div class="bar bar-footer-secondary">
            <a class="button button-block button-fill button-big" href="/receiptTrainItemAdd/<?php echo $data['detail']['ridKey']; ?>.html" external>添加支出</a>
          </div>
            <div class="content">
              <div class="content-block pLR-n">
                ...
                <div class="list-block media-list">
                  <ul>
                    <li>
                      <a href="/receiptItemDetail/<?php echo $v1['riidKey']; ?>.html" external class="item-link item-content">
